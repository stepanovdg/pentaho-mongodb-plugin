...
public class MongoDbOutputData extends BaseStepData implements StepDataInterface {
   ...
   * @throws KettleException if a problem occurs
   */
  public DBObject getModifierUpdateObject( List<MongoDbOutputMeta.MongoField> fieldDefs, RowMetaInterface inputMeta,
   ...
   */
  public static DBObject getQueryObject( List<MongoDbOutputMeta.MongoField> fieldDefs, RowMetaInterface inputMeta,
                                         Object[] row, VariableSpace vars, MongoTopLevel topLevelStructure )
    throws KettleException {
   ...
   * @throws KettleException if a problem occurs
   */
  public static DBObject kettleRowToMongo( List<MongoDbOutputMeta.MongoField> fieldDefs, RowMetaInterface inputMeta,
                                           Object[] row, VariableSpace vars, MongoTopLevel topLevelStructure,
   ...
   */
  public static MongoTopLevel checkTopLevelConsistency( List<MongoDbOutputMeta.MongoField> fieldDefs,
